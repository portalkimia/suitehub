...
4. Jalankan fungsi `buatTokenAksesGuru()` satu kali dari editor GAS. Salin token dari **Execution log** dan simpan di password manager.
...
7. Jalankan `cekKonfigurasiKeamanan()` bila ingin memeriksa konfigurasi tanpa menampilkan nilai rahasia.
