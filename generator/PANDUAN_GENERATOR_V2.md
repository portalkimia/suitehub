...
- Template diperiksa sebelum penyalinan: Topik/Kelas/Tujuan wajib, bagian ITP/pertemuan terisi harus memiliki placeholder, placeholder tidak dikenal ditolak. CP/SumberCP opsional agar template lama tetap didukung; tambahkan {{CP}} dan {{SumberCP}} bila ingin mencetaknya. Placeholder pada header/footer perlu dipindahkan ke badan dokumen. Pemeriksaan sisa placeholder dijalankan sebelum dokumen dinyatakan selesai.
